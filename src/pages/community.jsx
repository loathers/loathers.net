  ...
  return (
    <Layout pageTitle="Community">
      ...
      <ul>
        ...
        <li>If you haven't visited the <a href="https://wiki.kingdomofloathing.com/Main_Page">KOL Wiki</a>, <a href="https://github.com/kolmafia/kolmafia">installed KOLMafia</a>, or actually played the <a href="https://www.kingdomofloathing.com/">Kingdom of Loathing</a>... I mean, well, it's pretty impressive you got this far in our website, frankly. But you should probably check out those things, absolutely nothing contained in this website makes a lick of sense without them!</li>
      </ul>
      <hr />
