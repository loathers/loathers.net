...
Copies and faxes are super important parts of speedrunning. When you're trying to aggressively cut turns, you want to spend as few turns as possible generating the monsters you need to generate. Banishes, macrometeorite-likes, and free runs are good ways to accomplish this. But simply summoning the monster into existence saves the use of every single one of those, which is a massive boon to anyone with a need for speed. It also, amusingly, makes copies pretty hard to value. 
