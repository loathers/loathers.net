...
In the prior sections, I mentioned a few specific synergies already, like the obvious connection with the <a href="/analysis/2024-09-sept-ember-censer">Sept-Ember Censer</a> (2024). Two others bear slightly more mention.

- The <a href="/analysis/2025-09-monodent">Monodent of the Sea</a> (2025) pairs quite well with the BCZ as well; the extra substats from fighting your 13+ Some Fish a run are actually quite meaningful when it comes to generating the stats needed to summon everything up. Not only that, Some Fish helps boost the power of 4-5 important Refracted Gaze targets per run, which is actually dope as hell. The extra stats help with boosting your scaling monsters a bit as well. There's a ton of synergy here!
