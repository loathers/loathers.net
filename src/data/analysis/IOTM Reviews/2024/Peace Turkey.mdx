...
- One interesting mechanical quirk of the Peace Turkey is that the postcombat drops can happen on runaways with the familiar. This is pretty strong -- it means that every freerun you get in a given run can be used to effectively cheat an extra familiar turn with your turkey. This synergizes very well with either the <a href="/analysis/2024-02-spring-shoes/">Spring Shoes</a> (2024) or the <a href="/analysis/2024-07-roman-candelabra/">Roman Candelabra</a> (2024), either of which can be used to get 1 freerun every 30 turns. (It also synergizes with its own free runs, so each banish you get is also a spare turn for your subsequent banishes). 
- As noted earlier, synergizes well with the Apriling piccolo or the Tiny Gold Medal from the <a href="2024-04-apriling-band-helmet">Apriling Band Helmet</a> (2024) or the <a href="2023-08-scepter">August Scepter</a> (2023). It also will synergize nicely with any future sources of familiar weight, making it the first familiar since 2019's Pocket Professor where the familiar's turnsaving function actually gives a damn about familiar weight. (FIRST ONE IN FIVE YEARS. WHAT.)
