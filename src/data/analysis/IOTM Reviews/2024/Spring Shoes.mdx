...
- As noted in our <a href="/analysis/2024-01-black-apron/">Black Apron</a> article, there's a mild synergy in that your shoes can produce some of the fruits needed to improve your meals.
- As noted above, Spring Kick can synergize with the <a href="/analysis/2023-09-bofa/">Book of Facts</a> (2023) by allowing you to effectively defer/delay using up your Recall Habitat copies until you have a delay zone open. You'd prefer to just route around having enough delay to use them all, but this isn't a terrible use.
