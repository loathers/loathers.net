...
- In addition to the base game value, the cold resistance from Synapse Blaster works nicely with the <Link to="/analysis/2024-09-sept-ember-censer/">Sept-Ember Censer</Link>. Five whole res equates to a biiiiiiig old gob of extra stats with your Mmm-brr Mouthwash. Runners with a full standard suite will likely find this the only "major" use for the Synapse Blaster, as other free resist sources will usually fit the bill for the other base game uses. But it's a nice little tool in your pocket!
