...
Instead of our normal "speedrun applicability" section, I'm going to start this one by attempting to explain -- mechanically -- how Steal Monster's Heart works. 
...
- Government Agent (3, +1 turn apiece, only in paths where you can access Portscan.exe via the Source Terminal)
...
1. T = Frat 151 via Numberology, A = Peridot a Bar, P = Summon/copy a Black Crayon Shape, E = Peridot + olfact a ninja waiter 
2. T = elegant nightstand, A = Peridot a Fleaman, P = Copy a Black Crayon Shape, E = ninja waiter 
3. T = pygmy witch nurse, A = Find a Fleaman, P = Copy a Black Crayon Shape, E = Peridot a Keese
4. T = Peridot a Tektite, A = oil cartel, P = Peridot a Hippy Baker, E = Peridot + olfact a Foodie Giant
5. T = Frattlesnake (it's D2!), A = oil cartel, P = Peridot a Hippy Baker (it's D2!), E = Peridot a Foodie Giant
6. T = Peridot a Tektite, A = oil cartel, P = Find a Hippy Baker, E = Find a Foodie Giant 
7. T = Find a Tektite, A = oil cartel, P = Find a Homeopath, E = red skeleton 
8. T = Peridot a pygmy witch nurse, A = oil cartel, P = Find a Homeopath, E = tomb servant 
