...
It does a lot of other random stuff too, though. Unlike Disgeist's cold lack of in-combat assistance or post-combat actions, the Peace Turkey is all about the love. It starts each combat with a delevel on round 1, blocks enemy attacks at random all throughout combat, and (sometimes) procs an after-combat boost in a specific order. In order, the boosts are:
...
This is an *extremely nice* use of marginal familiar turns. Not only are you helping yourself search for necessary in-run NCs, you're *also* generating a banish every time you hit two whirled peas. Because the drop order is a given, you'll get your first banish on the 5th postcombat drop from your turkey and every other banish 8 postcombat drops after this.
