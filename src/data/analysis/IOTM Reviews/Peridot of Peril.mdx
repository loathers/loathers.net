...
All of this is great stuff, and super useful. And this doesn't even cover the most mind-numbing face-stabby speedrun usage of all: exploiting the superlikely to get free chances at *other* superlikely monsters! Once the delay for the Boss Bat or Copperhead Snakes, you can wear the Peridot to fish for an encounter at no cost. It usually doesn't work, but you might as well! It's free real estate, baby! 
...
We rate the Peridot of Peril a tier 0 IOTM. It's difficult to isolate all the turn savings this IOTM gives you; it's not quite as flexible as something like the Chest Mimic, which allows you to grab things that are not native to the game's adventuring zones (like your obligatory Mountain Man and swarms of ghoul whelps), but it also represents (essentially) 30-40 useful copies every single run. I don't think that every single one of those copies saves a full turn, but even if they average out as a half a turn or a little under, that's still 15+ turns -- easily clearing our mark for the tippiest-toppiest tier around. Sound the alarm: this IotM's a real gem!
