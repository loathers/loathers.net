...
- **Piccolo** - gives your current familiar +40 fxp
...
- **Fxp** is something that we've been getting more commonly now, and with 3x40 fxp available to be allocated, the **piccolo** delivers for those familiars that really want to gain poundage ASAP.
...
Almost everything about the Apriling band helmet is independently good. The only IotM synergy lies with the **apriling band piccolo**, which is a +10 weight familiar equipment that grants fxp. Here are some ideas for how to use it:

- +40 fxp transforms a 25-fxp **Grey Goose** into a 65-fxp one, instantly allowing for 3 drones
- +120 fxp allows a **Chest Mimic** to extrude two egg copies, or one egg "fax"

Because you get 3 shots of 40 fxp, rather than 1 shot of 120 fxp, you can really get creative with how you distribute the gains; this will benefit those who can use the experience at maximum utility by splitting their uses up and getting to exact thresholds rather than overloading your Goose.
