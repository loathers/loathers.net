...
- For *2 embers*, the **throwing ember** (a deeply strange damaging banish that needs to kill the target to actually work)
- For *4 embers*, the **structural ember** (+5/5 bridge parts)

Although there are other items in the shop, these are the ones that will see regular use. To look at the other items, check out [the wiki!](https://wiki.kingdomofloathing.com/Your_Sept-Ember_Censer)
...
- Finally, the throwing ember is a kill banish, which is both uncommon and useful in that you get to keep the monster's drops. This is very helpful for zones where there are monsters you don't want to see more than once, such as an Elegant Animated Nightstand or (perhaps) the final Pygmy Witch Accountant.
