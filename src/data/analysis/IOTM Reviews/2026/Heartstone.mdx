...
I don't love stealing away an A. But I don't really mind the rest of these. Beefy bodyguard bat and waiter dressed as a ninja are both pretty easy. This one probably requires some math. You need to make sure that it actually saves 1-2 turns. If so, though, it could be a neat little 1 turn summon. 
