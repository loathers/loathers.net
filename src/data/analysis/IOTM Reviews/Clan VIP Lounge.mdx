...
Nowadays, in unrestricted, this is great if you don't have the other modern yellow ray or red ray sources (... basically, parka/candles and <a href="/analysis/2024-03-dart-holster/">the dart holster</a>) and middling if you do. The hat is still worth a small amount of turns, and is increasingly powerful the fewer -com sources you have. 
...
**COLLABORATIVE FEATURE:** Nothing, actually. You can pick your nose in the shower, but you can't pick your friends to shower with. (Everyone's buddy, sweaty bill, has called me out here -- technically, the recipes you learn via hot showers are all gift items. So that's the collaborative feature. I still think that's -basically- nothing, but I suppose it's worth calling out.)
...
**COLLABORATIVE FEATURE:** The entirety of the fax machine! Obviously. (Also, the looking glass gives a few gift items.)
...
**COLLABORATIVE FEATURE:** Pool is essentially a little PVP-esque battle. You have a certain amount of pool skill and your opponent has a certain amount of pool skill, and the one with more wins. Some players are **extremely** committed to pool -- in Bonus Adventures from Hell, for instance, Pantsless is on the precipice of having won 1 million games of pool in a row with 987,562 wins and counting. Also, the Crimbo Tree gives gift items, meant to be shared with your fellow player.
