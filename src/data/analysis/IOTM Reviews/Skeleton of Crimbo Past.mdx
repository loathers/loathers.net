...
Also, helpfully, the adventure yield is quite good. A yield of 5.5 adventures per potency that can be generated at scale is better than most of this year's food and beverage options. To wit, we've had:
...
Still, these items are clearly going to be among the best ways to fill your gullet if you are simply trying to maximize turns. Not only are these better than your basic replacement-level options, they're also size 2 -- this is nice, since it lowers the number you have to generate to fill your organs. While I doubt we're going to have anyone who does a run with 200-300 turns of skeleton just for the turngen, it really wouldn't surprise me if we're looking at a 1-day standard meta in the next year or two that does get 6-7 consumables from this guy. 
...
So! How many can you actually expect to get? It's a good question, and one that's relatively complicated to answer. By dint of the *highly* skewed distribution, you would very much prefer to use your skeleton on fights with aligned phyla. If you're going to try and only use your skeleton on fights where there's a decent chance of a knucklebone drop, those fights will primarily consist of:
...
Per expectation, then, you have sort of a sliding scale of usage.

- If you only want a few consumables, you can spend about 10-15 turns with the skelly between the Nook and the Logging camp for +2 consumables
- If you want some more, you can spend 20-25 turns across the normal dude monsters you hit in a run and get +2 consumables above that 
- If you want even more, you can spend 35-45 turns across some lesser tertiary options (Giant Castle, Yossarian, a variety of beasts via all level quests, the rest of the cyrpt) and get +2 consumables above that

All this said -- I don't really think that you'll want to dip too deep on this chain of possible skelly fights. Most runners will have a perfectly cromulent time if they simply use the skelly for all their Defiled Nook & Logging Camp fights, get a total of 3 consumables, and call it a day. Once you start spending 20-70 extra turns with this little guy, you apply pressure to the turns available for significantly more critical familiar benefits, like Chest Mimic eggs or Yeti effects.

## 2025 In-Standard Synergies

- There's some synergy with this year's <Link to="/analysis/2025-02-toy-cupids-bow">toy cupid's bow</Link>; the familiar equipment is meaningful if you're trying to get more than 3 consumables, likely shaving off 1-2 familiar turns per consumable achieved. Not a massive boon, but good enough.

## Overall Rating

The Skeleton of Crimbo Past is a tier 4 IOTM. Per my [fun-for-the-whole-family tiering explanations](https://docs.google.com/spreadsheets/d/1pDTE8VhuSyH03xvkVW5JGvTQf7PYitaNGLMHLVXz_5A/edit?gid=652855806#gid=652855806), that's reserved for IOTMs that save 0-2 turns per day. I think that's a pretty reasonable number to attribute to this little guy. The buffs from the food and booze are meaningful enough that it probably adds up to a very tiny handful of turns in a 2-day run. This would probably be more akin to a tier 5 with imperceptible turn-saving value... except that the turngen boost is substantial enough over the next-best options that it may well be a critical piece of a 1-day meta in the next few years. A pretty tiny little guy all things considered, but as the proud father of a 12-foot-skeleton (Jalen, pictured below in a snow-yarmulke), I am a biased man: skeletons are awesome and this little guy is pretty good too.
