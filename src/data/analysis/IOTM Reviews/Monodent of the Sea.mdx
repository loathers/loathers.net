...
- The <Link to="/analysis/2025-10-blood-cubic-zirconia">blood cubic zirconia's</Link> skills all cost substats to use, and Some Fish are scalers, so you can stack up a bunch of extra substats from fighting those fish. Also, in paths without access to CLEESH, Talk to Some Fish is a good alternative when casting BCZ: Refracted Gaze to get drops from every monster in a zone.
