...
Each player who submits a run will get 3 million meat. That's right -- 3 mil just for playing! What a steal! There will be four prize-winning categories. First, we will be splitting by Hardcore and Normal. Second, we will be splitting by "Full Shiny" and "Half Shiny". That means we will be splitting participants up by the percentage of the full shiny IOTM set they own at time of their run. There are currently 24 "normal" IOTMs, 3 IOTYs, 2 TTT items, and 1 special item (Oliver's) in standard. That means that anyone with less than 16 shinies will be in their own "½✨" category; hopefully, this will allow people with incomplete standard sets to play for some of the bigger prizes!
...
In addition, the contest managers reserve the right to add a handful of extra "cute" prizes at the end, like a prize for (say) "most improved" or a prize for someone sharing their strategy publicly to help their fellow speedsters. (As a rule, I am very devoted to helping more and more people find speedrunning fun.)
...
Simple -- fill out [this Google form]() every time you do a run!
