...
```
is wrong, and you'll be able to correct it with the name of the [correct item](https://wiki.kingdomofloathing.com/Unwrapped_knock-off_retro_superhero_cape) before compiling and running your code.
