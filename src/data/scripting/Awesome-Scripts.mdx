...
> Scripts to automate your KOL ascensions. Really, there's only one! (At least, one "easy" one. More later.)
...
> Scripts that provide supplemental user interfaces for various IOTMs over the years, improving your user experience by making usage a little easier
...
| owner | link | usage |
|---------|------|---------|
| [Loathers](https://github.com/loathers) | [Philter GitHub](https://github.com/loathers/locket-ui/) | Click "reminisice" to activate the Locket UI page |
...
| owner | link | usage |
|---------|------|---------|
| Aventuristo (#3028125) | [cc_snapshot on the KoL Forums](https://forums.kingdomofloathing.com/vb/showthread.php?t=250707) | Run the script in the GCLI |
