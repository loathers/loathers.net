...
- For an introduction to ASH and an overview on its pros and cons, <a href="/scripting/ash-overview/">check our ASH starter kit</a>.
- If you would like to see some information about JS in the context of KoL, <a href="/scripting/js-overview/">check our JS overview page</a>.
