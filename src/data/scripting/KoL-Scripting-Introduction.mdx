...
- Sometimes, the best way to learn is to read scripts made by others. You can find a wealth of these on the [KOLMafia Forums](https://kolmafia.us/#repository.3) or on the [Loathers GitHub](https://github.com/loathers/) 
...
- For an introduction to ASH and an overview on its pros and cons, <Link to="/scripting/ash-overview/">check our ASH starter kit</Link>.
- If you would like to see some information about JS in the context of KoL, <Link to="/scripting/js-overview/">check our JS overview page</Link>.
