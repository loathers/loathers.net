I've just uninstalled all of my TS development programs from my windows computer. Let's see what the process is like to get things installed again!
...
One of the listed package managers is nvm, which I mentioned on my list above! Shit!
...
I'm going to clone an existing repo for my very first repo. The first thing I'm going to do is create a new folder somewhere on my computer--because I was born after 1990, that folder is on my desktop, and because it's 11:15 PM and I haven't slept very well lately, that folder is titled "New Folder."
...
And here we hit the first snaggle of the night:
...
- VSCode defaulted to opening a `command prompt`, but a little dropdown menu lets me open a `git bash`. And listen, if git itself doesn't recognize git as a command, that's when we're neck deep in hot dog water. This doesn't feel like a great solution though
...
It doesn't say it did anything, but that strikes me as better than an error message.
